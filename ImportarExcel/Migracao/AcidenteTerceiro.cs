...
{
    public static class AcidenteTerceiro
    {


        public static String Sql()
        {
            string sql = "SELECT [INDICADORES MENSAIS DE ACIDENTES DO TRABALHO_EFETIVO DE TERCEIRO] AS EMPRESA, " +
                                "F9, F16, F23, F30, F37, F44, F51, F62, F69, F76, F82, F88, F94 " +
                         " FROM ['Acidentes Terceiros$$'] WHERE F6<>'' ";
